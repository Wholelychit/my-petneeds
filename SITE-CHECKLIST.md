...
- `small-pets.html` — Small pets
- `senior-pets.html` — Senior pets
- `rescue.html` — Rescue pets
- `ask-ai.html` — Ask AI planning page
- `emergency.html` — Safety guide
- `upload-photo.html` — Photo ideas
- `about.html` — About
...
- Header wraps cleanly on phone.
- Navigation links are easy to tap.
- Buttons are full-width where helpful.
- Cards stack in one column on small screens.
- Forms are readable and easy to use.
- Footer links do not crowd each other.
...
- Add more simple pet category guides.
